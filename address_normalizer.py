...
- Expected JSON: {{"normalized_address": "1600 Amphitheatre Parkway, Mountain View, CA 94043, USA", "confidence_score": 1.0, "improvements_made": "Added country, standardized format", "missing_info": "None", "address_quality": "Complete"}}

**Example 2 (Incomplete Address):**
- Input: "Capiata, Other, 2560"
- Expected JSON: {{"normalized_address": "Capiatá, Central Department, Paraguay", "confidence_score": 0.4, "improvements_made": "Corrected spelling, added department and country, removed invalid ZIP", "missing_info": "Street address, house number", "address_quality": "City level only"}}

**Example 3 (Messy Address):**
- Input: "caleradelsur95@gmail.com casa, virgen del rosario y parana -general artigas, itapua, 0000"
- Expected JSON: {{"normalized_address": "Calle Virgen del Rosario y Paraná, General Artigas, Itapúa Department, Paraguay", "confidence_score": 0.6, "improvements_made": "Removed email, corrected spelling, standardized street format, added department and country", "missing_info": "House number, specific street intersection details", "address_quality": "Street level"}}
